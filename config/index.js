export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx3333e7ded0e30f22"",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "b4fc982f967a8fa64b0bfebf4e9bf09b",
  ...
  USERS: [
    {
      ...
      id: "oTyMv5nJNUS4CKGcuy5JVHNl5TL0","oTyMv5irUWkon3f7HXKwdUgJWbBY"
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "0upH8jfk5Ou7clIBmTHS6cEsaDBDFJ9y8lFYeLl1CNo",
      // 所在省份
      province: "云南",
      // 所在城市
      city: "昆明",
